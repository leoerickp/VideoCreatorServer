...
const options: swaggerJSDoc.Options = {
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description: 'Video Creator API manage data for .... This an example created for this project. It was writen using [https://editor.swagger.io/](https://editor.swagger.io/) as editor and **swagger-jsdoc** and **swagger-ui-express** component'
        }
    },
